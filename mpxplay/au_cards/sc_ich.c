...
static const uint16_t AD1980_WIN98_REGISTER_VALUES[] = {
    // 0     2       4       6       8       a       c       e
    0x0090, 0x0303, 0x0303, 0x0003, 0x0000, 0x0000, 0x8008, 0x8048, // 00
    0x8888, 0x0c0c, 0x0000, 0x8888, 0x0707, 0x0000, 0x0808, 0x0000, // 10
    0x0000, 0x0000, 0x0000, 0x000f, 0x03c3, 0x3831, 0x49b3, 0xbb80, // 20
    0xbb80, 0xbb80, 0x0000, 0x8080, 0x8080, 0x2000, 0x0000, 0x0000, // 30
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, // 40
    0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x1000, 0x0000, // 50
    0x8080, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, 0x0000, // 60
    0x0000, 0x0a88, 0x7000, 0xe428, 0x0000, 0x0000, 0x4144, 0x5370, // 70
};
...
static void snd_intel_prepare_playback(struct intel_card_s *card,struct mpxplay_audioout_info_s *aui)
{
 ...
 // Analog Devices AD1980: Fix audio routing (set HPSEL and LOSEL bits)
 // https://www.analog.com/media/en/technical-documentation/data-sheets/AD1980.pdf
 ...
 if (vendor_id1 == AC97_VENDOR_ID1_AD && vendor_id2 == AC97_VENDOR_ID2_AD1980) {
     snd_intel_codec_write(card, AC97_AD_MISC,
             snd_intel_codec_read(card, AC97_AD_MISC) | AC97_AD_MISC_HPSEL | AC97_AD_MISC_LOSEL);
 }
